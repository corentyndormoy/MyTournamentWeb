 ...
 */
final class Version20210412065248 extends AbstractMigration
{
    ...
    public function up(Schema $schema) : void
    {
        ...
        $this->addSql('CREATE TABLE sport_match (id INTEGER PRIMARY KEY AUTOINCREMENT NOT NULL, first_team_id INTEGER NOT NULL, second_team_id INTEGER NOT NULL, field_id INTEGER NOT NULL, tournament_id INTEGER NOT NULL, starting_at DATETIME NOT NULL, duration TIME NOT NULL, first_team_score INTEGER DEFAULT NULL, second_team_score INTEGER DEFAULT NULL)');
        ...
        $this->addSql('CREATE TEMPORARY TABLE __temp__user AS SELECT id, team_id, first_name, last_name, mail, phone, username, password, gender, player_number, roles FROM user');
        ...
        $this->addSql('INSERT INTO user (id, team_id, first_name, last_name, mail, phone, username, password, gender, player_number, roles) SELECT id, team_id, first_name, last_name, mail, phone, username, password, gender, player_number, roles FROM __temp__user');
